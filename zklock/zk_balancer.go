...
import (
	...
	netutils "github.com/bxsmart/bxcore/utils/net"
...
const balancerShareBasePath = "/bxsmart_balancer"
...
func (zb *ZkBalancer) Init(name string, initTasks []Task) error {
	...
	if len(zb.localIpPrefix) <= 0 {
		zb.localIpPrefix = localIpPrefix
	}
	zb.workerPath = netutils.GetLocalIpByPrefix(zb.localIpPrefix)
	zb.mutex = sync.Mutex{}
	return nil
}
